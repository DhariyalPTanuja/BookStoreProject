...
import com.bridgelabz.bookstore.dto.ResponseBookDTO;
...
@RestController
@RequestMapping("/bookStoreApp/cart")
public class CartController {
    ...
    public ResponseEntity<ResponseBookDTO> updateBookQuantity(@RequestBody CartDTO cartDTO,@PathVariable Long id,@RequestParam int quantity) {
       CartModel cartModel = serviceCart.updateQuantity(cartDTO,id,quantity);
